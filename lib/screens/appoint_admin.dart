...
class dViewAppointmentScreen extends StatefulWidget {
  const dViewAppointmentScreen({super.key});

  @override
  State<dViewAppointmentScreen> createState() => _dViewAppointmentScreenState();
}

class _dViewAppointmentScreenState extends State<dViewAppointmentScreen> {
  @override
